...
public class CRUDProdutosResources {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Produto> alterarProduto(@PathVariable Integer id, @Valid @RequestBody Produto produto) throws IllegalArgumentException, IllegalAccessException {
